...
def main():
    ...
    while True:
        ...
        if elapsed_time > update_freq:
            ...
            world.set_weather(carla.WeatherParameters(precipitation_deposits=70.0, wind_intensity = 100.0, sun_azimuth_angle = 180.0, sun_altitude_angle = 40)) # Testing
            print(world.get_weather().sun_azimuth_angle) # Testing
